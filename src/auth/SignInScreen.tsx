    ...
    <div className="min-h-screen bg-iron-950 flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-end p-8 pb-16">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <span className="font-mono text-iron-400 text-xs">START</span>
          <div className="flex-1 h-px bg-iron-700" />
        </div>
        ...
        <button
          onClick={signIn}
          className="w-full flex items-center justify-center gap-3 bg-acid text-black font-sans font-bold py-4 px-6 uppercase tracking-widest text-sm active:scale-98 transition-transform"
